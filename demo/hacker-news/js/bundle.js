...
var _componentsNewContentJsx = require('./components/newContent.jsx');

var _componentsNewContentJsx2 = _interopRequireDefault(_componentsNewContentJsx);
...
var Container = _react2['default'].createClass({
  ...
  getInitialState: function getInitialState() {
    return {
      renderComponent: _react2['default'].createElement(_componentsNewContentJsx2['default'], { source: 'https://hacker-news.firebaseio.com/v0/newstories.json' }),
      component: null
    };
  },
  ...
  render: function render() {
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(_componentsMenuJsx2['default'], { component: this.changeComponent }),
      _react2['default'].createElement(
        'div',
        { className: 'container' },
        _react2['default'].createElement('a', { className: 'goto-top', href: '#main-container' }),
...
_react2['default'].render(_react2['default'].createElement(Container, null), target);

},{"./components/menu.jsx":3,"./components/newContent.jsx":4,"react":162}],2:[function(require,module,exports){
...
var _newContentJsx = require('./newContent.jsx');

var _newContentJsx2 = _interopRequireDefault(_newContentJsx);

var _showContentJsx = require('./showContent.jsx');

var _showContentJsx2 = _interopRequireDefault(_showContentJsx);

var _jobsContentJsx = require('./jobsContent.jsx');

var _jobsContentJsx2 = _interopRequireDefault(_jobsContentJsx);
...
var Menu = _react2['default'].createClass({
  ...
  changeMenu: function changeMenu(index) {
    ...
    if (index == 0) {
      this.props.component(_react2['default'].createElement(_newContentJsx2['default'], { source: 'https://hacker-news.firebaseio.com/v0/newstories.json' }));
    } else if (index == 1) {
      this.props.component(_react2['default'].createElement(_showContentJsx2['default'], { source: 'https://hacker-news.firebaseio.com/v0/newstories.json' }));
    } else if (index == 2) {
      this.props.component(_react2['default'].createElement(_jobsContentJsx2['default'], { source: 'https://hacker-news.firebaseio.com/v0/newstories.json' }));
    }
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        this.state.items.map((function (item, index) {
          return _react2['default'].createElement(
            'li',
            { className: item.selected ? 'selected' : '', onClick: this.changeMenu.bind(this, index), key: item.id },
            item.name
          );
        }).bind(this))
      )
...
},{"./jobsContent.jsx":2,"./newContent.jsx":4,"./showContent.jsx":5,"react":162}],4:[function(require,module,exports){
...
},{"./spinner.jsx":6,"react":162}],5:[function(require,module,exports){
