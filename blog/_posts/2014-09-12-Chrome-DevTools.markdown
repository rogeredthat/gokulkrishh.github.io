...
<img class="post-image" src="/blog/images/devtools/Inspect Element.gif" alt="devtool" title="click to open in new tab" onclick="window.open('/blog/images/devtools/Inspect Element.gif','_blank');">
...
<img class="post-image" src="/blog/images/devtools/copy as html.gif" alt="copy as html" title="click to open in new tab" onclick="window.open('/blog/images/devtools/copy as html.gif','_blank');">
...
<img class="post-image" src="/blog/images/devtools/console.gif" alt="writing function in console" title="click to open in new tab" onclick="window.open('/blog/images/devtools/console.gif','_blank');">
...
<img class="post-image" src="/blog/images/devtools/dom.gif" alt="Dom inspection in console" title="click to open in new tab" onclick="window.open('/blog/images/devtools/dom.gif','_blank');">
